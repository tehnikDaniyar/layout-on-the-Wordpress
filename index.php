		...
		<main class="main">
					...
					<div class="slider-works__swiper swiper">
						<div class="slider-works__wrapper swiper-wrapper">
							<div class="slider-works__slide swiper-slide">
								<img class="slider-works__img" src="/img/slider-works/01.jpg" alt="">
							...
							<div class="slider-works__slide swiper-slide">
								<img class="slider-works__img" src="/img/slider-works/02.jpg" alt="">
								<div class="slider-works__decore">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
									vulputate laoreet sapien a sit ante.
								</div>
							</div>
							<div class="slider-works__slide swiper-slide">
								<img class="slider-works__img" src="/img/slider-works/03.jpg" alt="">
								<div class="slider-works__decore">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
									vulputate laoreet sapien a sit ante.
								</div>
							</div>
				...
				<div class="benefits__container">
					<div class="benefits__items">
						<div class="benefits__item">
							<img src="/img/benefits/01.svg" alt="icon-benefits" class="benefits__icon">
						...
						<div class="benefits__item">
							<img src="/img/benefits/02.svg" alt="icon-benefits" class="benefits__icon">
						...
						<div class="benefits__item">
							<img src="/img/benefits/03.svg" alt="icon-benefits" class="benefits__icon">
						...
						<div class="benefits__slider-swiper swiper">
							<div class="benefits__slider-wrapper swiper-wrapper">
								<div class="benefits__slider-slide swiper-slide">
									<img src="/img/benefits/image.jpg" alt="img" class="benefits__slider-image">
			...
			<div class="gds">
				<div class="gds__container">
					<div class="gds__item">
						<div class="gds__icon"><img src="/img/gds/01.svg" alt=""></div>
					...
					<div class="gds__item">
						<div class="gds__icon"><img src="/img/gds/02.svg" alt=""></div>
						<div class="gds__title">Защитные пленки</div>
						<div class="gds__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nascetur ultrices
							pellentesque vulputate sit. Ut feugiat.
						</div>
					...
					<div class="gds__item">
						<div class="gds__icon"><img src="/img/gds/03.svg" alt=""></div>
						<div class="gds__title">Защитные пленки</div>
						<div class="gds__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nascetur ultrices
							pellentesque vulputate sit. Ut feugiat.
						</div>
					...
					<div class="gds__item">
						<div class="gds__icon"><img src="/img/gds/04.svg" alt=""></div>
						<div class="gds__title">Защитные пленки</div>
						<div class="gds__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nascetur ultrices
							pellentesque vulputate sit. Ut feugiat.
						</div>
				...
				<div class="benefits__container">
					<div class="benefits__slider">
						<div class="benefits__slider-swiper swiper">
							<div class="benefits__slider-wrapper swiper-wrapper">
								<div class="benefits__slider-slide swiper-slide">
									<img src="/img/benefits/image2.jpg" alt="img" class="benefits__slider-image">
									<p class="benefits__slider-description">Lorem ipsum dolor sit amet, consectetur adipiscing
										elit.
										Pellentesque auctor nibh feugiat est. Consectetur lectus.
									</p>
					...
					<div class="benefits__items">
						<div class="benefits__item">
							<img src="/img/benefits/04.svg" alt="icon-benefits" class="benefits__icon">
			...
			<section class="ourworks">
				...
				<div class="ourworks__gallery">
					<img src="/img/ourworks/gallery/01.jpg" alt="work">
					<img src="/img/ourworks/gallery/02.jpg" alt="work">
					<img src="/img/ourworks/gallery/03.jpg" alt="work">
					<img src="/img/ourworks/gallery/04.jpg" alt="work">
					<img src="/img/ourworks/gallery/05.jpg" alt="work">
					<img src="/img/ourworks/gallery/06.jpg" alt="work">
					<img src="/img/ourworks/gallery/05.jpg" alt="work">
					<img src="/img/ourworks/gallery/01.jpg" alt="work">
					<img src="/img/ourworks/gallery/04.jpg" alt="work">
					<img src="/img/ourworks/gallery/03.jpg" alt="work">
				...
				<div class="ouranswer__container">
					...
					<form action="#" class="ouranswer__form">
						...
						<div class="ouranswer__social">
							<a href="#" class="ouranswer__link"><img src="/img/ouranswer/icons/twitter.svg" alt="twitter"></a>
							<a href="#" class="ouranswer__link"><img src="/img/ouranswer/icons/youtube.svg" alt="yuutobe"></a>
							<a href="#" class="ouranswer__link"><img src="/img/ouranswer/icons/vk.svg" alt="vk"></a>
						</div>
						<button class="ouranswer__button" type="submit">отправить</button>
						<div class="ouranswer__contacts">
							<a href="#" class="ouranswer__link"><img src="/img/ouranswer/icons/point.svg" alt="point"><span>Eu
									faucibus et rutrum fringilla orci nunc</span></a>
							<a href="tel:88121234567" class="ouranswer__link"><img src="/img/ouranswer/icons/tel.svg"
									alt="tel"><span>8 (812) 123-45-67</span></a>
							<a href="mail:test@test.ru" class="ouranswer__link"><img src="/img/ouranswer/icons/message.svg"
